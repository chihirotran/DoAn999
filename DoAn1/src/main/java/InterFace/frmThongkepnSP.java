 ...
 * @author chihi
 */
public class frmThongkepnSP extends javax.swing.JPanel {
private final  DefaultTableModel tbModel = new DefaultTableModel();
    ...
    public frmThongkepnSP() throws SQLException {
        initComponents();
        initComponents();
        ...
        if (KtNut() == true) {
            if (radXemngay.isSelected() == true) {
                try {
                    ...
                    Logger.getLogger(frmThongkepnSP.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
